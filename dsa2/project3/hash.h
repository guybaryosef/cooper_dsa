...
class hashTable {
 ...
 public:
   ...
   */
  void *getPointer(const std::string &key, bool *b = NULL) const;
 ...
 private:
  ...
  class hashItem {
  public:
    hashItem() : isOccupied(false), isDeleted(false), pv(NULL) {};
  ...
  /*
   * The two hash functions. The second hash function is used for
